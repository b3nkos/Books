...
class SortedArray:
    ...
    def binary_search_first_occurrence(self, target: Union[int, float]) -> Union[int, None]:
        pass
    ...
    def delete_by_index(self, index: int) -> None:
        """Delete a target value from the sorted array by its index."""
    ...
    def traverse(self, callback):
        """
        Traverse a sorted array and call a callback function on each element.
